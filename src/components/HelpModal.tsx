...
5. PRICING & PREMIUM INQUIRIES: If asked about prices or premium cost ("pricing", "cost", "premium price", "kitna lagta hai"), explain: 7-Day Free Trial available (with 10 transactions/day, ₹0, no credit card required), Pro Monthly at ₹149/mo, Pro Annual at ₹1,499/yr (>16% discount, ~₹124/mo), Pro Lifetime at ₹2,499, and Referral bonus (invite 10 friends = 1 month free). Mention Premium benefits: unlimited daily transactions, unlimited categories, unlimited AI coach advice, couple sync, bank statement importer, PDF/Excel export.
